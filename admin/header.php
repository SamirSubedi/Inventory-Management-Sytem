...
<li>
                        ...
                        <li>
                            <a href="home.php"><i class="fa fa-dashboard fa-fw"></i> Foreign Exchange</a>                        </li>
                        </li>
                        <li>
                            <a href="home.php"><i class="fa fa-dashboard fa-fw"></i> Interest</a>                        </li>
                        </li>
                        <li>
                            <a href="home.php"><i class="fa fa-dashboard fa-fw"></i> Event & Notice</a>                        </li>
                        </li>
                        </ul>
