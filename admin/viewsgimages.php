...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Bhanu Gallery</h1>
                </div>
...
<tbody>
                                        <tr>
                                            ...
                                            <td><a href='gchangeimage.php?key0=<?php echo  $row["gid"];?>&asid2=<?php echo $row["aid"]; ?>'><img src="gupload/<?php echo $row["gimages"]; ?>"  width="100px"/></a></td>
